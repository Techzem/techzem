(function (window, document, $, undefined) {
  ...
  var rsthemeJs = {
    ...
    customjsActive: function () {
      ...
      $(".rs-sidebar-demo .collaps-btn, .panel-btn-part .collaps-btn").click(
        function () {
          $(this).parents("html").toggleClass("demo-is-open");
        }
      );

      $(".canvasmenu-trigger, .menu-canvas-layer, .menu-canvas-close").click(
        function () {
      ...
      $(
        ".offcanvas-menu .offcanvas-menu-inner ul.nav-menu .has-clid > a"
      ).click(function (t) {
        t.preventDefault();
      ...
      function mainSlider() {
        ...
        BasicSlider.on("init", function (e, slick) {
          var $firstAnimatingElements =
            $(".items:first-child").find("[data-animation]");
        ...
        BasicSlider.on(
          ...
          function (e, slick, currentSlide, nextSlide) {
            var $animatingElements = $(
              '.items[data-slick-index="' + nextSlide + '"]'
            ).find("[data-animation]");
