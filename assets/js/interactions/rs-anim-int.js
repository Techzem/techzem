(function ($) {
  ...
  function gsap_rs_split_text() {
    setTimeout(function () {
      var splitTextElements = $(
        ".rs-section-title .title, .rs-newsletter-2__box .title, .rs-about-3__content .title, .section-title-2 .title,.rs-cta-3__box .title,.rs-about__box .title"
      );
  ...
  function gsap_rs_custom_cursor() {
    ...
    if (cursorBall) {
      ...
      // Common Area
      $(
        "a, button, input[type=submit], .slick-arrow, .slick-dots li button, .rs-search-box .search_icons"
