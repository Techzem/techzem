          ...
          (protoProps = [
            ...
            },
            {
              ...
              value: function (hiddenIndex) {
                ...
                Object(_helpers_array__WEBPACK_IMPORTED_MODULE_1__.a)(
                  ...
                  $hiddenTab.removeClass(classNames.active).attr({
                    "aria-selected": !1,
                    tabindex: -1,
                  }),
            ...
            },
            {
              ...
              value: function (shownIndex, argument_1) {
                ...
                Object(_helpers_array__WEBPACK_IMPORTED_MODULE_1__.a)(
                  ...
                  $currentTab.addClass(classNames.active).attr({
                    "aria-selected": !0,
                    tabindex: 0,
                  }),
            ...
            },
            {
              ...
              value: function (event) {
                ...
                switch (action) {
                  case "prev":
                    this[autoselect ? "go" : "moveFocus"](-1, {
                      focus: !0,
                    });
                    break;
                  case "next":
    ...
    var api = {
      ...
      goTo: function (query) {
        switch (_typeof(query)) {
          ...
          case "string":
            "#" === query[0] &&
              this.goTo(this.getIndexByHash(query), {
                updateHistory: !1,
              });
            break;
          default:
